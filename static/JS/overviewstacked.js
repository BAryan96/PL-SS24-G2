...
function openPopup(chartInstance, requestData) {
  ...
  const tableSelectY2 = createLabeledSelect(
    "Table for Y-Axis 2",
    "tableSelectY2"
  );
  const columnSelectY2 = createLabeledSelect(
    "Column for Y-Axis 2",
    "columnSelectY2"
  );
  const aggregationSelect2 = createLabeledSelect(
    "Aggregation 2",
    "aggregationSelect2"
  );
  const tableSelectY3 = createLabeledSelect(
    "Table for Y-Axis 3",
    "tableSelectY3"
  );
  const columnSelectY3 = createLabeledSelect(
    "Column for Y-Axis 3",
    "columnSelectY3"
  );
  const aggregationSelect3 = createLabeledSelect(
    "Aggregation 3",
    "aggregationSelect3"
  );
