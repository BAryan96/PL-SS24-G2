  ...
  submitButton.addEventListener("click", async (event) => {
    ...
    if (
      ...
      try {
        ...
        filterCloseButton.style.margin = "10px auto";
        filterCloseButton.addEventListener("click", () => {
          filterContent.style.display = "none";
        });
        filterContent.appendChild(filterCloseButton);
        ...
        searchInput.addEventListener("input", () => {
          ...
          const optionsX = filterContent.querySelectorAll(
            ".filter-options-x label"
          );
          const optionsY = filterContent.querySelectorAll(
            ".filter-options-y label"
          );
          optionsX.forEach((option) => {
        ...
        filterContent.addEventListener("change", () => {
          ...
          option.series[0].data = filteredDataX.map((x, index) => ({
            value: filteredDataY[index],
            name: x,
            itemStyle: {
              color: responseData.colors ? responseData.colors[index] : null,
            },
          }));
          ...
          series: [
            {
              ...
              data: dataX.map((x, index) => ({
                value: dataY[index],
                name: x,
                itemStyle: {
                  color: responseData.colors
                    ? responseData.colors[index]
                    : null,
                },
              })),
            },
        ...
        setupContextMenu(chartInstance, option.series);
      } catch (error) {
